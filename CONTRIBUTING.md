...
- Use lintcheck in a project, and give us feedback on what worked and what
  didn't.
- Write a blog post about your experiences with lintcheck, good or bad.
...
lintcheck is developed on GitHub. Code
...
When helping others use lintcheck, please remember that you are
...
doing Y, lintcheck does Z instead, which I prefer because...") or talk
